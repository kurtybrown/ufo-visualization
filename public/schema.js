//  enigma utiliza archivos json llamados schemas para ver qué apis están disponibles en cada versión de qlik
...
window.schema = 
{
	"structs": {
		...
		"Doc":{
			...
			"SetAppProperties": {
				"In": [{ "Name": "qProp","DefaultValue": {"qTitle": "", "qLastReloadTime": "", "qMigrationHash": "", "qSavedInProductVersion": "", "qThumbnail": {"qUrl": ""}, "qHasSectionAccess": false} }],
				"Out": []
			},
			"GetAppProperties": {
				"In": [],
			...
			"DoReloadEx": {
				"In": [{ "Name": "qParams","DefaultValue": {"qMode": 0, "qPartial": false, "qDebug": false, "qReloadId": ""}, "Optional": true }],
				"Out": [{ "Name": "qResult" }]
			},
			"BackCount": {
				"In": [],
			...
			"CreateBookmarkEx": {
				"In": [{ "Name": "qProp","DefaultValue": {"qInfo": {"qId": "", "qType": ""}, "qMetaDef": {}} }, { "Name": "qObjectIdsToPatch","DefaultValue": [""], "Optional": true }],
				"Out": [{ "Name": "qInfo" }]
			},
			"SaveAs": {
